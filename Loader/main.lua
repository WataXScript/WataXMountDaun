...
local saveFile = "WataX_Key_mdn.txt"
...
if lastKey and isKeyValid(lastKey) then
    ...
    mainFrame.Visible = false
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXMountDaun/main/Loader/WataX.lua"))()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXMountDaun/main/Loader/mainmap926.lua"))()
end
